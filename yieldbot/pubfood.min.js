    ...
    return function t(e, i, r) {
        ...
        1: [function(t, e, i) {
            ...
            o.prototype._events = void 0, o.prototype.listeners = function(t, e) {
                ...
                if ("function" == typeof l.fn) {
                    ...
                    for (d = 0; c > d; d++) switch (l[d].once && this.removeListener(t, l[d].fn, void 0, !0), h) {
                        ...
                        case 3:
                            ...
                            break;
                        default:
                            if (!u) for (p = 1, u = new Array(h - 1); h > p; p++) u[p - 1] = arguments[p];
                ...
                var s = this._events[o],
                    a = [];
                if (e) if (s.fn)(s.fn !== e || r && !s.once || i && s.context !== i) && a.push(s);
                else for (var u = 0, d = s.length; d > u; u++)(s[u].fn !== e || r && !s[u].once || i && s[u].context !== i) && a.push(s[u]);
        ...
        6: [function(t, e, i) {
            ...
            r.prototype.EVENT_TYPE = {
                ...
                return e && this.EVENT_TYPE.AUCTION_POST_RUN !== t || (e = !0, this.observeImmediate_[t] = this.observeImmediate_[t] || [], this.observeImmediate_[t].push(Array.prototype.splice.call(arguments, 1))), e
            }, r.prototype.on = function(t, e) {
                var i = this.observeImmediate_[t] || null;
                if (i) {
                    for (var r = 0; r < i.length; r++) e(i[r]);
                    return this
                }
        ...
        8: [function(t, e, i) {
            ...
            var r = {
                ...
                history: [],
                dumpLog: function(t) {
                    if (console && console.log) for (var e = 0; e < this.history.length; e++) {
        ...
        10: [function(t, e, i) {
            ...
            r.prototype.init = function() {
                ...
                for (var r in i) if (e = i[r].call(this), e = i[r].warn ? !0 : e, !e) {
                ...
                return e && (this.slots.push(e), this.slotMap[e.name] = e), this
        ...
        11: [function(t, e, i) {
            ...
            r.prototype.processBids = function(t) {
                ...
                i.provider = e, o.publish(o.EVENT_TYPE.BID_PUSH_NEXT, i)
        ...
        15: [function(t, e, i) {
            ...
            r.prototype.setMediator = function(t) {
                ...
                this.auctionDelegate.refresh(t, e)
            }, e.exports = r
        }, {
            "../event": 6,
            "../interfaces": 7,
        ...
        16: [function(t, e, i) {
            ...
            r.withDelegate = function(t) {
                ...
                this.bidDelegate.refresh(t, e, i)
            }, e.exports = r
        }, {
            "../event": 6,
            "../interfaces": 7,
        ...
        17: [function(t, e, i) {
            ...
            ! function(t, i, r) {
                ...
                var d = function() {
                    ...
                    for (var i = l.prototype.getSlots(), r = 0; r < i.length; r++) for (var o = 0; o < i[r].bidProviders.length; o++) {
                ...
                return l.prototype.dumpLog = function(t) {
                    ...
                    if (n.logCall("api.observe", arguments), "function" == typeof t) for (var i in r.EVENT_TYPE) r.on(r.EVENT_TYPE[i], o.bind(t, this));
        ...
        18: [function(t, e, i) {
            ...
            var r = {
                ...
                loadUri: function(t, e) {
                    var i = document,
                        r = t || "";
                    if (e) if ("complete" === i.readyState || "loaded" === i.readyState);
                    else try {
                ...
                validate: function(t, e) {
                    if (!e) return !1;
                    var i = 0;
                    for (var o in t) if ("optional" !== o) {
                        var n = !! t.optional && !! t.optional[o],
                            s = e.hasOwnProperty(o),
                            a = !! e[o],
                            u = !e.init;
                        if (n || s && a || ++i, a && u && r.isArray(e[o]) && 0 === e[o].length && ++i, a && !u && r.asType(e[o]) !== r.asType(t[o]) && ++i, i > 0) break
                    }
                    return !i
                }
            };
