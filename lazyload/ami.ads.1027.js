...
ami.mensfitness.ads = (function() {
    return {
        ...
        initialize: function() {
            ...
            window.addEventListener("scroll",function(){
                var ad1 = document.getElementById("dfp-ad-right1_300x250");
                var below_ad = document.getElementById("block-mf-homepage-mf-homepage-videos");
                document.getElementById("console1").innerHTML = ad1.getBoundingClientRect().bottom;
                document.getElementById("console2").innerHTML  = below_ad.getBoundingClientRect().top;
            ...
            window.addEventListener("scroll",function(){
                var ad1 = document.getElementById("dfp-ad-right2_300x250");
                var below_ad = document.getElementById("block-ami-mostpopular-1");
                document.getElementById("console1a").innerHTML = ad1.getBoundingClientRect().bottom;
                document.getElementById("console2a").innerHTML  = below_ad.getBoundingClientRect().top;
                if(ad1.getBoundingClientRect().bottom !== below_ad.getBoundingClientRect().top){
                    var paddingTop = (ad1.getBoundingClientRect().bottom - below_ad.getBoundingClientRect().top);
...
if (document.documentElement.clientWidth < 768) {
    ...
    // if(document.getElementById("dfp-ad-mobile_box") !== null){
    //     ami.mensfitness.ads.addSlot({
    //         slotName: "mobile_box",
    //         adUnit: "/4216/mob.mensfitness" + adUnit,
    //         sizes: [
